...
String checkColor(String device, String command)
{
  ...
  if (device == Device1)
  {
    digitalWrite(13, int(command[0]^1)-'0'); //change string to int with ascii correction
    digitalWrite(12, int(command[1]^1)-'0');
    digitalWrite(14, int(command[2]^1)-'0'); 
    digitalWrite(2, int(command[3])-'0');
    //===Firebase update===//
